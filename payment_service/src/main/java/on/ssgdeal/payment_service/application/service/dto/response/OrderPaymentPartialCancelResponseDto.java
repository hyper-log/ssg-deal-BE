...
@Builder
public record OrderPaymentPartialCancelResponseDto(
    String paymentKey,
    String totalOrderId,
    Long totalAmount,
    String result
    ...
    public static OrderPaymentPartialCancelResponseDto success(Payment payment) {
        return OrderPaymentPartialCancelResponseDto.builder()
    ...
    public static OrderPaymentPartialCancelResponseDto fail(Payment payment) {
        return OrderPaymentPartialCancelResponseDto.builder()
            .paymentKey(payment.getPaymentKey())
            .totalOrderId(String.valueOf(payment.getTotalOrderId()))
            .totalAmount(payment.getPaymentAmount())
